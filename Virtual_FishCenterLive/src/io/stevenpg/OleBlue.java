 ...
 * Date: 5/31/2015
 * This class represents Ole Blue and contains
 * his relevant information throughout the
 * life of the application.
 */
public class OleBlue extends Fish{

	public OleBlue(Vector<Image> images, Rectangle edges, Component tank){
		this.tank = tank;
	...
	public void swim() {
		if(random.nextInt() % 7 <= 1){
			...
			velocity.x += random.nextInt() % 35;
			
			velocity.x = Math.min(velocity.x, 15);
			velocity.x = Math.max(velocity.x, -15);
			
			velocity.y += random.nextInt() % 10;
	...
	/**
	 * @see io.stevenpg.Fish#drawFishImage(java.awt.Graphics)
	 */
	@Override
