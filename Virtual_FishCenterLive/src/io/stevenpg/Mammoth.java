 ...
 * Date: 5/31/2015
 * This class represents Mammoth and contains
 * his relevant information throughout the
 * life of the application.
 */
public class Mammoth extends Fish {

	public Mammoth(Vector<Image> images, Rectangle edges, Component tank){
		this.tank = tank;
		...
		this.random = new Random(System.currentTimeMillis() + 6000);
		this.name = "Mammoth";
		this.location = new Point(
				900 + (Math.abs(random.nextInt()) % 300),
